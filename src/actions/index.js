...
export const API_URL = (process.env.API_URL ? process.env.API_URL : 'http://' + process.env.REACT_APP_HOST + ':3000') + '/api';
export const CLIENT_ROOT_URL = 'http://' + process.env.REACT_APP_HOST + ':' + process.env.REACT_APP_PORT;
